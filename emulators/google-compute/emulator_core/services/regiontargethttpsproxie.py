...
class RegionTargetHttpsProxie:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if self.id is not None and self.id != "":
            d["id"] = self.id
        d["kind"] = "compute#regiontargethttpsproxie"
        d["selfLink"] = f"https://www.googleapis.com/compute/v1/{self.name}"
        return d

class RegionTargetHttpsProxie_Backend:
    def __init__(self):
        self.state = GCPState.get()
        self.resources = self.state.region_target_https_proxies  # alias to shared store

    def _generate_id(self) -> str:
        return str(random.randint(10**17, 10**18 - 1))

    def _generate_name(self, prefix: str = "region-target-https-proxie") -> str:
...
using the data included in the request."""
        ...
        resource = RegionTargetHttpsProxie(
        ...
        resource_link = (
            f"projects/{project}/regions/{region}/targetHttpsProxies/{resource.name}"
        )
    ...
    def get(self, params: Dict[str, Any]) -> Dict[str, Any]:
        ...
        resource = self.resources.get(target_https_proxy)
        if not resource or (resource.region and resource.region != region):
            return create_gcp_error(
                404,
                f"The resource '{target_https_proxy}' was not found",
                "NOT_FOUND",
            )
...
to the specified project in the specified region."""
        ...
        return {
            "kind": "compute#regiontargethttpsproxieList",
            "id": f"projects/{project}/regions/{region}/targetHttpsProxies",
...
patch format and processing rules."""
    ...
    def setSslCertificates(self, params: Dict[str, Any]) -> Dict[str, Any]:
        ...
        body = params.get("RegionTargetHttpsProxiesSetSslCertificatesRequest") or {}
        if not body:
            return create_gcp_error(
                400,
                "Required field 'RegionTargetHttpsProxiesSetSslCertificatesRequest' not found",
                "INVALID_ARGUMENT",
            )
...
class region_target_https_proxie_RequestParser:
    @staticmethod
    def parse_request(
        method_name: str,
        ...
        parsers = {
            'get': region_target_https_proxie_RequestParser._parse_get,
            'setUrlMap': region_target_https_proxie_RequestParser._parse_setUrlMap,
            'setSslCertificates': region_target_https_proxie_RequestParser._parse_setSslCertificates,
            'patch': region_target_https_proxie_RequestParser._parse_patch,
            'insert': region_target_https_proxie_RequestParser._parse_insert,
            'list': region_target_https_proxie_RequestParser._parse_list,
            'delete': region_target_https_proxie_RequestParser._parse_delete,
        }
    ...
    def _parse_setSslCertificates(
        ...
        if 'requestId' in query_params:
            params['requestId'] = query_params['requestId']
        # Body params
        params['RegionTargetHttpsProxiesSetSslCertificatesRequest'] = body.get('RegionTargetHttpsProxiesSetSslCertificatesRequest')
        return params
...
class region_target_https_proxie_ResponseSerializer:
    @staticmethod
    def serialize(
        method_name: str,
        data: Dict[str, Any],
        ...
        serializers = {
            'get': region_target_https_proxie_ResponseSerializer._serialize_get,
            'setUrlMap': region_target_https_proxie_ResponseSerializer._serialize_setUrlMap,
            'setSslCertificates': region_target_https_proxie_ResponseSerializer._serialize_setSslCertificates,
            'patch': region_target_https_proxie_ResponseSerializer._serialize_patch,
            'insert': region_target_https_proxie_ResponseSerializer._serialize_insert,
            'list': region_target_https_proxie_ResponseSerializer._serialize_list,
            'delete': region_target_https_proxie_ResponseSerializer._serialize_delete,
        }
