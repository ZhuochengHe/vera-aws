...
class SslCertificate:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        d["kind"] = "compute#sslcertificate"
        d["selfLink"] = f"https://www.googleapis.com/compute/v1/{self.name}"
        return d

class SslCertificate_Backend:
    def __init__(self):
        self.state = GCPState.get()
        self.resources = self.state.ssl_certificates  # alias to shared store

    def _generate_id(self) -> str:
        return str(random.randint(10**17, 10**18 - 1))

    def _generate_name(self, prefix: str = "ssl-certificate") -> str:
...
included in the request."""
        ...
        resource_link = f"projects/{project}/global/sslCertificates/{resource.name}"
    ...
    def get(self, params: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if not resource:
            resource_path = (
                f"projects/{project}/global/sslCertificates/{certificate_name}"
            )
            return create_gcp_error(
                404,
...
project."""
        ...
        return {
            ...
            "id": f"projects/{project}/global/sslCertificates",
...
`returnPartialSuccess` parameter..."""
        ...
        if not resources:
            ...
            items = {scope_key: {"SslCertificates": [r.to_dict() for r in resources]}}
        return {
            "kind": "compute#sslcertificateAggregatedList",
            "id": f"projects/{project}/aggregated/sslCertificates",
            "items": items,
            "selfLink": "",
        }
    ...
    def delete(self, params: Dict[str, Any]) -> Dict[str, Any]:
        ...
        resource_link = f"projects/{project}/global/sslCertificates/{certificate_name}"
        return make_operation(
...
class ssl_certificate_RequestParser:
    @staticmethod
    def parse_request(
        method_name: str,
        ...
        parsers = {
            'insert': ssl_certificate_RequestParser._parse_insert,
            'list': ssl_certificate_RequestParser._parse_list,
            'aggregatedList': ssl_certificate_RequestParser._parse_aggregatedList,
            'delete': ssl_certificate_RequestParser._parse_delete,
            'get': ssl_certificate_RequestParser._parse_get,
        }
...
class ssl_certificate_ResponseSerializer:
    @staticmethod
    def serialize(
        method_name: str,
        data: Dict[str, Any],
        ...
        serializers = {
            'insert': ssl_certificate_ResponseSerializer._serialize_insert,
            'list': ssl_certificate_ResponseSerializer._serialize_list,
            'aggregatedList': ssl_certificate_ResponseSerializer._serialize_aggregatedList,
            'delete': ssl_certificate_ResponseSerializer._serialize_delete,
            'get': ssl_certificate_ResponseSerializer._serialize_get,
        }
