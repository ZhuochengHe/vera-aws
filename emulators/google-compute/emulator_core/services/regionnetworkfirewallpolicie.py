...
@dataclass
class RegionNetworkFirewallPolicie:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        d["kind"] = "compute#regionnetworkfirewallpolicie"
        d["selfLink"] = f"https://www.googleapis.com/compute/v1/{self.name}"
        return d

class RegionNetworkFirewallPolicie_Backend:
    def __init__(self):
        self.state = GCPState.get()
        self.resources = self.state.region_network_firewall_policies  # alias to shared store

    def _generate_id(self) -> str:
        return str(random.randint(10**17, 10**18 - 1))

    def _generate_name(self, prefix: str = "region-network-firewall-policie") -> str:
        return f"{prefix}-{uuid.uuid4().hex[:8]}"

    def _get_region_network_firewall_policy_or_error(self, name: str) -> Any:
    ...
    def insert(self, params: Dict[str, Any]) -> Dict[str, Any]:
        ...
        resource = RegionNetworkFirewallPolicie(
        ...
        resource_link = f"projects/{project}/regions/{region}/firewallPolicies/{resource.name}"
    ...
    def get(self, params: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if not firewall_policy:
            return create_gcp_error(400, "Required field 'firewallPolicy' not specified", "INVALID_ARGUMENT")
        resource = self._get_region_network_firewall_policy_or_error(firewall_policy)
...
for the specified project in the given region."""
        ...
        list_id = f"projects/{project}/regions/{region}/firewallPolicies"
        return {
            "kind": "compute#regionnetworkfirewallpolicieList",
            "id": list_id,
...
Replaces any existing policy."""
        ...
        resource = self._get_region_network_firewall_policy_or_error(resource_name)
        if is_error_response(resource):
            return resource
    ...
    def getEffectiveFirewalls(self, params: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            "kind": "compute#regionNetworkFirewallPoliciesGetEffectiveFirewallsResponse",
            "firewalls": [],
        }
...
policy or resource exists."""
    ...
    def cloneRules(self, params: Dict[str, Any]) -> Dict[str, Any]:
        ...
        target = self._get_region_network_firewall_policy_or_error(firewall_policy)
        if is_error_response(target):
            return target
        source = self._get_region_network_firewall_policy_or_error(source_policy_name)
        if is_error_response(source):
            return source
        target.rules = list(source.rules)
        target.rule_tuple_count = len(target.rules)
        resource_link = f"projects/{project}/regions/{region}/firewallPolicies/{target.name}"
        return make_operation(
    ...
    def delete(self, params: Dict[str, Any]) -> Dict[str, Any]:
        ...
        resource_link = f"projects/{project}/regions/{region}/firewallPolicies/{firewall_policy}"
        return make_operation(
...
class region_network_firewall_policie_RequestParser:
    @staticmethod
    def parse_request(
        method_name: str,
        ...
        parsers = {
            'testIamPermissions': region_network_firewall_policie_RequestParser._parse_testIamPermissions,
            'patchRule': region_network_firewall_policie_RequestParser._parse_patchRule,
            'addAssociation': region_network_firewall_policie_RequestParser._parse_addAssociation,
            'addRule': region_network_firewall_policie_RequestParser._parse_addRule,
            'removeRule': region_network_firewall_policie_RequestParser._parse_removeRule,
            'getRule': region_network_firewall_policie_RequestParser._parse_getRule,
            'getEffectiveFirewalls': region_network_firewall_policie_RequestParser._parse_getEffectiveFirewalls,
            'delete': region_network_firewall_policie_RequestParser._parse_delete,
            'insert': region_network_firewall_policie_RequestParser._parse_insert,
            'list': region_network_firewall_policie_RequestParser._parse_list,
            'getAssociation': region_network_firewall_policie_RequestParser._parse_getAssociation,
            'getIamPolicy': region_network_firewall_policie_RequestParser._parse_getIamPolicy,
            'setIamPolicy': region_network_firewall_policie_RequestParser._parse_setIamPolicy,
            'get': region_network_firewall_policie_RequestParser._parse_get,
            'removeAssociation': region_network_firewall_policie_RequestParser._parse_removeAssociation,
            'patch': region_network_firewall_policie_RequestParser._parse_patch,
            'cloneRules': region_network_firewall_policie_RequestParser._parse_cloneRules,
        }
    ...
    def _parse_getEffectiveFirewalls(
        ...
        if 'network' in query_params:
            params['network'] = query_params['network']
        return params
...
class region_network_firewall_policie_ResponseSerializer:
    @staticmethod
    def serialize(
        method_name: str,
        data: Dict[str, Any],
        ...
        serializers = {
            'testIamPermissions': region_network_firewall_policie_ResponseSerializer._serialize_testIamPermissions,
            'patchRule': region_network_firewall_policie_ResponseSerializer._serialize_patchRule,
            'addAssociation': region_network_firewall_policie_ResponseSerializer._serialize_addAssociation,
            'addRule': region_network_firewall_policie_ResponseSerializer._serialize_addRule,
            'removeRule': region_network_firewall_policie_ResponseSerializer._serialize_removeRule,
            'getRule': region_network_firewall_policie_ResponseSerializer._serialize_getRule,
            'getEffectiveFirewalls': region_network_firewall_policie_ResponseSerializer._serialize_getEffectiveFirewalls,
            'delete': region_network_firewall_policie_ResponseSerializer._serialize_delete,
            'insert': region_network_firewall_policie_ResponseSerializer._serialize_insert,
            'list': region_network_firewall_policie_ResponseSerializer._serialize_list,
            'getAssociation': region_network_firewall_policie_ResponseSerializer._serialize_getAssociation,
            'getIamPolicy': region_network_firewall_policie_ResponseSerializer._serialize_getIamPolicy,
            'setIamPolicy': region_network_firewall_policie_ResponseSerializer._serialize_setIamPolicy,
            'get': region_network_firewall_policie_ResponseSerializer._serialize_get,
            'removeAssociation': region_network_firewall_policie_ResponseSerializer._serialize_removeAssociation,
            'patch': region_network_firewall_policie_ResponseSerializer._serialize_patch,
            'cloneRules': region_network_firewall_policie_ResponseSerializer._serialize_cloneRules,
        }
